class FlareAnalizer{
    ...
    // flare analyzer class

    constructor(angle, radius, width, height, id, freq){

        // CONFIG

        this.easingFactor = 0.03; // easing factor for amplitude value (0: no change, 1: instant change)
        this.angularSpeed = random(0.03, 0.3); // range for angular rotation speed
